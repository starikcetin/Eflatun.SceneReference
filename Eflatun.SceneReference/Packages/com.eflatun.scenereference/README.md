...
```json
"com.eflatun.scenereference": "git+https://github.com/starikcetin/Eflatun.SceneReference.git#1.2.1"
```

_Although it is highly discouraged, you can replace `1.2.1` with `upm` to get the latest version instead of a specific one._
